...
PLOT_EVERY = 1
FFT_WINDOW_SAMPLES = 1000  # (kept for future use)
...
# === PLOT SETUP ===
plt.ion()
# Commented out FFT axis for now
    ...
    while plt.get_fignums():
        if running:
            try:
                ...
                # === FFT temporarily disabled ===
                # if samples_since_fft >= FFT_WINDOW_SAMPLES and len(x_buffer) > FFT_WINDOW_SAMPLES:
                #     samples_since_fft = 0
